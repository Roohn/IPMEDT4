...
public class FaqLijst extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        Vragen[] lijstjeVragen = new Vragen [6];
        ...
        lijstjeVragen[4] = new Vragen("Mag ik autorijden als ik in het gips zit?", "Hier is veel onduidelijkheid over, het is niet verboden, maar in sommige autoverzekeringspolisvoowaarden staat aangegeven dat er in het geval van rijden met gips bij een ongeluk niets wordt uitgekeerd.");
        lijstjeVragen[5] = new Vragen("Kan ik lopen op mijn ingegipste been?", "Alleen als je loopgips hebt en dan ten alle tijden met de loopzool die je daar bij krijgt.");
